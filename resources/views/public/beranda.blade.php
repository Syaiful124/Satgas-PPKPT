...
<div class="relative h-[60vh] md:h-[90.5vh] w-full mb-12">
    <div class="h-full w-full">
        <div class="absolute inset-0 bg-black bg-opacity-50 px-20 flex flex-col justify-center text-white gap-8 text-center">
            <h1 class="text-4xl md:text-5xl font-bold font-serif mb-4 leading-tight py-8">
                <span class="text-transparent bg-clip-text bg-gradient-to-br from-gray-100 to-orange-500">"Satgas PPKPT: Garda Depan Integritas Kampus STIMATA."</span>
                </h1>
            <p class="text-lg mb-6">Kami berkomitmen untuk menciptakan lingkungan kampus yang aman, inklusif, dan bebas dari kekerasan seksual. Melalui situs ini, Anda dapat melaporkan insiden, mengakses sumber daya pendukung, dan mempelajari lebih lanjut tentang upaya kami dalam pencegahan dan penanganan kekerasan di lingkungan perguruan tinggi.</p>
        ...
        <div class="block h-[60vh] md:h-[90.5vh] w-auto">
            <img src="{{ asset('images/beranda.jpeg') }}" alt="Tim Satgas" class="w-full h-full object-cover">
        </div>
    </div>
</div>

<section id="tentang-kami" class="flex flex-col w-auto gap-8 mb-6 m-6">
    <div class="text-center">
        <h2 class="text-3xl font-bold text-gray-800">Tentang Satgas PPKPT</h2>
        <p class="text-center text-gray-500 ">Pelajari lebih lanjut mengenai Visi dan Misi, Tugas, Wewenang, dan Kode Etik.</p>
    </div>

    <div id="info-tabs">
        <div class="flex justify-center space-x-2 md:space-x-4 mb-2" role="tablist">
            <button role="tab" data-target="#ppkpt" class="tab-button tab-active">
            ...
            <button role="tab" data-target="#visi-misi" class="tab-button">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16"><path d="M5.338 1.59a61.44 61.44 0 0 0-2.837.856.481.481 0 0 0-.328.39c-.554 4.157.726 7.19 2.253 9.188a10.725 10.725 0 0 0 2.287 2.233c.346.244.652.42.893.533.12.057.218.095.293.118a.55.55 0 0 0 .101.025.615.615 0 0 0 .1-.025c.076-.023.174-.061.294-.118.24-.113.547-.29.893-.533a10.726 10.726 0 0 0 2.287-2.233c1.527-1.997 2.807-5.031 2.253-9.188a.48.48 0 0 0-.328-.39c-.651-.213-1.75-.56-2.837-.855C9.552 1.29 8.531 1.067 8 1.067c-.53 0-1.552.223-2.662.524zM5.072.56C6.157.265 7.31 0 8 0s1.843.265 2.928.56c1.11.3 2.229.655 2.887.87a1.54 1.54 0 0 1 1.044 1.262c.596 4.477-.787 7.795-2.465 9.99a11.775 11.775 0 0 1-2.517 2.453 7.016 7.016 0 0 1-1.048.625c-.28.132-.581.24-.829.24s-.548-.108-.829-.24a7.015 7.015 0 0 1-1.048-.625 11.777 11.777 0 0 1-2.517-2.453C1.928 10.487.545 7.169 1.141 2.692A1.54 1.54 0 0 1 2.185 1.43 62.456 62.456 0 0 1 5.072.56z"/><path d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/></svg>
                <span>Visi & Misi</span>
                <div class="tab-pointer"></div>
            </button>
            <button role="tab" data-target="#tugas" class="tab-button">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-orange-200 text-space-y-4">
            <div id="tugas" role="tabpanel" class="tab-content hidden">
            ...
            <div id="visi-misi" role="tabpanel" class="tab-content hidden">
            ...
            <div id="ppkpt" role="tabpanel" class="tab-content text-center font-medium p-4">
                <p class="text-gray-700"><h3 class="text-lg font-bold mb-2">Pencegahan dan Penanganan Kekerasan di Perguruan Tinggi (PPKPT)</h3>adalah sebuah sistem atau kerangka kerja komprehensif yang dirancang untuk menciptakan lingkungan kampus yang aman, inklusif, dan bebas dari segala bentuk kekerasan, termasuk kekerasan seksual, perundungan (bullying), diskriminasi, serta kekerasan fisik dan psikis. Sistem ini berfokus pada dua pilar utama: pertama, tindakan pencegahan yang proaktif melalui edukasi, sosialisasi, dan pembangunan budaya anti-kekerasan di kalangan mahasiswa, dosen, dan tenaga kependidikan. Kedua, mekanisme penanganan yang jelas, adil, dan berpihak pada korban, yang mencakup prosedur pelaporan yang aman dan rahasia, penyediaan layanan pendampingan dan pemulihan (seperti bantuan psikologis, hukum, dan medis), serta proses investigasi yang akuntabel dan penerapan sanksi tegas bagi pelaku untuk memastikan keadilan dan mencegah terulangnya kasus.</p>
            </div>
        </div>
    </div>
</section>

<section id="alur-pengaduan" class="p-6 bg-gray-50 mb-6">
    <div class=" mx-auto px-4">
        ...
        <div id="timeline-container" class="relative">
            ...
            <div class="relative flex mb-4 md:mb-6 gap-4 md:gap-0 md:flex-row flex-col">
                <div class="md:w-1/2 md:pr-3 text-left flex md:text-right w-full">
                ...
                <div class="md:w-1/2 md:pl-3 text-left flex w-full">
            ...
            <div class="relative flex mb-4 md:mb-6 gap-4 md:gap-0 md:flex-row flex-col">
                <div class="md:w-1/2 md:pr-3 text-left flex md:text-right w-full">
                    <div class="p-6 bg-white rounded-lg shadow-md border-l-4 border-orange-500 flex items-end flex-col">
                        ...
                        <p class="text-gray-600 mt-1">Hasil pemeriksaan tersebut akan diteruskan ke ketua satgas untuk ditindaklanjuti, sesuai dengan rekomendasi dari petugas. Jangkan waktu untuk melakukan tindak lanjut Kemudian korban akan mendapat update layanan pemulihan (psikologis, akademik, administratif).</p>
                    </div>
                </div>
                <div class="md:w-1/2 md:pl-3 text-left flex w-full">
                    <div class="p-6 bg-white rounded-lg shadow-md border-r-4 border-orange-500">
...
<section class="p-6">
    <div class="max-w-6xl mx-auto">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-2">Galeri Satgas PPKPT</h2>
        <p class="text-center text-gray-500 mb-6">Dokumentasi oleh Satgas PPKPT.</p>

        @if($galeriItems->isNotEmpty())
            <div class="relative p-4 bg-gray-200 rounded-lg shadow-lg ">
                <div id="gallery-container" class="flex pb-4 overflow-x-auto snap-x snap-mandatory space-x-3 scrollbar-hide rounded-lg w-full">
                    @foreach ($galeriItems as $item)
                        <div data-index="{{ $loop->index }}" class="gallery-slide flex-none w-[49.4%] max-h-[500px] snap-center">
                            <a href="{{ $item->url }}" data-fancybox="gallery" data-caption="{{ $item->caption }}" class="group relative block bg-gray-900 rounded-lg overflow-hidden hover:scale-auto">
                                @if ($item->type == 'image')
                                    <img src="{{ $item->url }}" alt="Galeri Kegiatan" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-300">
                                @else
                                    <video class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-300" muted preload="metadata">
                ...
                <div id="gallery-dots" class="absolute bottom-2 left-0 right-0 flex justify-center space-x-2">
                    @php $dotCount = ceil($galeriItems->count() / 1); @endphp
                    @for ($i = 0; $i < $dotCount; $i++)
                        <button data-index="{{ $i }}" class="gallery-dot w-3 h-3 rounded-full transition-all duration-300"></button>
                    @endfor
                </div>
            </div>
        @else
...
<section class="p-6 mb-6">
    <div class="flex flex-col mx-auto px-4 gap-6">
        <div class="flex flex-col ">
            ...
            <p class="text-center text-gray-500">Satgas PPKPT STMIK PPKIA Pradnya Paramita Malang</p>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // === 2. SKRIP UNTUK TIMELINE (MOBILE RESPONSIVE) ===
    ...
    // === 3. SKRIP UNTUK GALERI DOTS ===
    const galleryContainer = document.getElementById('gallery-container');
    const dotsContainer = document.getElementById('gallery-dots');
    const slides = document.querySelectorAll('.gallery-slide');
    const dots = document.querySelectorAll('.gallery-dot');

    if (galleryContainer && dotsContainer && slides.length > 0 && dots.length > 0) {

        function updateActiveDot(activeDotIndex) {
            dots.forEach(dot => {
                if (parseInt(dot.dataset.index) === activeDotIndex) {
        ...
        dotsContainer.addEventListener('click', function(e) {
            if (e.target.classList.contains('gallery-dot')) {
                ...
                const slideIndexToScroll = dotIndex * 1;

                if (slides[slideIndexToScroll]) {
                    slides[slideIndexToScroll].scrollIntoView({
                        behavior: 'smooth',
                        block: 'nearest',
                        inline: 'start'
                    });
        ...
        const observer = new IntersectionObserver(entries => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    const activeSlideIndex = parseInt(entry.target.dataset.index);
                    const activeDotIndex = Math.floor(activeSlideIndex / 1);
