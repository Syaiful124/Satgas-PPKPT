...
<body class="bg-gray-100 flex flex-col min-h-screen">
    <header class="text-black shadow-md w-full px-4 py-3">
        <nav class="mx-auto flex justify-between items-center ml-2">
            <a href="{{ route('beranda') }}" class="flex items-center space-x-2 gap-2 cursor-pointer hover:text-orange-500">
                <div>
                    <img src="{{ asset('images/logo.jpg')}}" alt="STIMATA" class="w-10 object-cover">
                </div>
                <p class="font-bold text-xl w-auto">
            ...
            <div class="hidden md:flex items-center space-x-4 w-auto">
                ...
                @auth
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="bg-red-300 px-4 py-2 rounded-md hover:bg-red-500 hover:text-white">
                            Logout</button>
                    </form>
                @else
        ...
        <div id="mobile-menu" class="mobile-menu hidden md:hidden absolute top-15 right-0 px-6 pt-2 pb-4 space-y-2 w-auto rounded-lg shadow-lg flex flex-col justify-end items-end gap-1 bg-white">
            <a href="{{ route('pengaduan.create') }}" class="bg-orange-300 hover:bg-orange-500 hover:text-white px-2 py-1 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
                </svg>
                Kirim Pengaduan
            </a>
            <a href="{{ route('unduhan') }}" class="hover:text-orange-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
                </svg>
            ...
            <a href="{{ route('hubungi.kami') }}" class="hover:text-orange-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                </svg>
                Hubungi Kami
            ...
            @auth
                <a href="{{ route('account.index') }}" class="hover:text-orange-500">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="bg-red-300 px-2 py-1 rounded-md hover:bg-red-500 hover:text-white">
                        Logout</button>
                </form>
            @else
                <div class="flex gap-1">
                    <a href="{{ route('login') }}" class="bg-green-300 px-2 py-1 rounded-md hover:bg-green-500 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0z"/>
                        <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
                        </svg>
                    ...
                    <a href="{{ route('register') }}" class="bg-blue-300 px-2 py-1 rounded-md hover:bg-blue-500 hover:text-white">
                        Register
                    </a>
                </div>
            @endauth
