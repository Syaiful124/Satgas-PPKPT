    ...
    <div class="header-sidebar">
        <header class="md:hidden bg-white shadow-md p-4 flex justify-start gap-4 items-center">
            ...
            <div class="flex items-center gap-2">
                <img src="{{ asset('images/logo.jpg')}}" alt="STIMATA" class=" w-8 object-cover">
                <h1 class="text-lg font-bold text-gray-800">SATGAS PPKPT</h1>
            </div>
        </header>
        <div id="sidebar-overlay" class="fixed inset-0 bg-black bg-opacity-50 z-20 hidden md:hidden"></div>
        <aside id="sidebar" class="w-[250px] sidebar fixed flex flex-col justify-between h-screen md:sticky top-0 transform -translate-x-full md:translate-x-0 z-30 transition-transform duration-300 ease-in-out shadow-lg border-lg">
            <div class="w-full">
